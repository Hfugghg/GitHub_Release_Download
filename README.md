...
请使用下面的命令只克隆 `main` 分支的最新一次提交，以避免下载不必要的数据：

```bash
git clone --branch main --depth 1 --single-branch [https://github.com/Hfugghg/GitHub_Release_Download.git](https://github.com/Hfugghg/GitHub_Release_Download.git)
```
